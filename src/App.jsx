...
const PATHFINDING_ALGORITHMS = {
  ...
  dijkstra: {
    name: "Dijkstra",
    fn: dijkstra,
    description: "Dijkstra's Algorithm - Guarantees shortest path",
  },
  astar: {
    name: "A*",
    fn: aStar,
    description: "A* Search - Guarantees shortest path, uses heuristic",
  },
};
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 text-sm justify-center">
        ...
        <div className="flex items-center gap-2">
          <div
            className="w-4 h-4 rounded"
            style={{ backgroundColor: COLORS.swapping }}
          />
...
function PathfindingVisualizer() {
  ...
  const runAlgorithm = async () => {
    ...
    const generator = PATHFINDING_ALGORITHMS[algorithm].fn(
      gridCopy,
      startNode,
      endNode,
    );
